...
import { ChevronRight, ChevronDown, CheckCircle, PlayCircle, Sparkles, Calendar, Clock } from 'lucide-react';
    ...
    return (
      <React.Fragment key={task.id}>
        <div className="flex border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
          ...
          <div className="w-[400px] min-w-[400px] p-3 border-r border-gray-200 dark:border-gray-700" style={{ paddingLeft: `${indentPx + 12}px` }}>
            <div className="flex items-center gap-2">
              {/* Collapse/Expand */}
              {hasChildren ? (
                <button
          ...
          {/* Right side: Timeline (unified scroll) */}
          <div className="flex-1 relative h-14 bg-gray-50 dark:bg-gray-900/20">
