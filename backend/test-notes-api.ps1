...
Write-Host "✓ Created section: $($response1.section.name) (ID: $sectionId)" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Created section: $($response2.section.name) (ID: $sectionId2)" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Created note: $($response3.note.title) (ID: $noteId1)" -ForegroundColor Green
...
Write-Host "✓ Created note: $($response4.note.title) (ID: $noteId2)" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Created note: $($response5.note.title) (ID: $noteId3)" -ForegroundColor Green
Write-Host ""

# Test 6: Get All Notes
Write-Host "Test 6: Get All Notes..."
$allNotes = Invoke-RestMethod -Uri "$baseUrl/notes" -Method Get
Write-Host "✓ Retrieved $($allNotes.total) notes" -ForegroundColor Green
...
Write-Host "✓ Retrieved $($allSections.total) sections" -ForegroundColor Green
...
Write-Host "✓ Retrieved section: $($sectionDetail.section.name)" -ForegroundColor Green
...
Write-Host "✓ Added $($response9.added) note(s) to section" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Found $($filtered.total) notes with category 'key-highlight'" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Found $($filtered2.total) notes linked to Banking organization" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Updated note: $($response12.note.title)" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Reordered notes in section" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Archived section: $($response14.section.name)" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Found $($activeSections.total) active sections" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Removed note from section" -ForegroundColor Green
Write-Host ""

# Test 17: Search Notes
Write-Host "Test 17: Search Notes..."
$search = Invoke-RestMethod -Uri "$baseUrl/notes?search=cloud" -Method Get
Write-Host "✓ Found $($search.total) notes matching 'cloud'" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Retrieved note: $($singleNote.note.title)" -ForegroundColor Green
