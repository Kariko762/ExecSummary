...
interface ExecutiveSynthesisRendererProps {
  ...
  isEditMode?: boolean;
  onChange?: (newData: ExecutiveSynthesisData) => void;
}
...
export const ExecutiveSynthesisRenderer: React.FC<ExecutiveSynthesisRendererProps> = ({ 
  ...
  const handleAiDataApply = (aiData: ExecutiveSynthesisData) => {
    if (onChange) {
  ...
  return (
    <div className="space-y-3">
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-roobert-bold text-white">Executive Synthesis</h3>
          </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                ...
                {isEditMode ? (
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed font-roobert-regular">
                    {data.context}
                  </p>
                )}
              </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                ...
                {isEditMode ? (
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed font-roobert-semibold">
                    {data.recommendation}
                  </p>
                )}
              </div>
      ...
      <AiPromptModal
        ...
        promptType="executiveSynthesis"
        userData={data}
        componentName="Executive Synthesis"
