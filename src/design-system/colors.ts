...
/**
 * Helper function to get CSS color variables at runtime
 */
 ...
 * NOW READS FROM CSS VARIABLES (centralized design system)
 */
export const ChartColors = {
  // Primary data series colors (from CSS variables)
  series: {
    eggplant: getCSSColor('--brand-primary', '#431C5B'),
    eggplantLight: getCSSColor('--brand-primary', '#6B1B5E'),
    navy: getCSSColor('--accent-blue', '#1D1F48'),
    raspberry: getCSSColor('--brand-secondary', '#B21A53'),
    green: getCSSColor('--accent-green', '#3bcd3e'),
    purple: getCSSColor('--brand-primary', '#403040'),
  },
  ...
  // NOW READS FROM CSS VARIABLES
  palette: [
    getCSSColor('--brand-primary', '#431C5B'),
    getCSSColor('--brand-secondary', '#B21A53'),
    getCSSColor('--accent-blue', '#3B82F6'),
    getCSSColor('--accent-green', '#10B981'),
    getCSSColor('--accent-yellow', '#F59E0B'),
    getCSSColor('--accent-red', '#EF4444'),
  ],
  ...
  paletteExtended: [
    ...
    getCSSColor('--accent-yellow', '#F59E0B'),
    getCSSColor('--accent-red', '#EF4444'),
    getCSSColor('--semantic-success', '#10B981'),
    getCSSColor('--semantic-warning', '#F59E0B'),
    getCSSColor('--semantic-error', '#EF4444'),
    getCSSColor('--brand-secondary', '#EC4899'),
  ],
