          ...
          <div style={{ backgroundColor: PAQ_COLORS.lightGray, borderRadius: '12px', padding: '12px', marginBottom: '16px' }}>
            <div style={{ backgroundColor: 'white', borderRadius: '8px', border: '1px solid #E5E7EB', padding: '12px' }}>
              {[
                ...
                <div key={idx} style={{ display: 'flex', gap: '10px', marginBottom: idx < 4 ? '12px' : '0' }}>
                  <div style={{ width: '28px', height: '28px', borderRadius: '6px', backgroundColor: `${PAQ_COLORS.magenta}20`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <span style={{ fontWeight: '700', fontSize: '13px', color: PAQ_COLORS.magenta }}>{step.num}</span>
                  </div>
                  <div>
                    <div style={{ fontWeight: '600', color: PAQ_COLORS.navy, marginBottom: '2px', fontSize: '12px' }}>{step.title}</div>
                    <div style={{ fontSize: '11px', color: `${PAQ_COLORS.navy}99` }}>{step.tool}</div>
                  </div>
                </div>
              ))}
            </div>
