...
import { Target, AlertTriangle, Download, X, Sparkles } from 'lucide-react';
...
// Component
export default function LeadershipTemplate({ data: propData, onExportReady, contentRef: parentContentRef, onClose }: LeadershipTemplateProps) {
      ...
      >
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-lg font-roobert-medium text-white">
                  {data?.meta?.title || 'Weekly Leadership Summary - Jan 20-26, 2026'}
                </h1>
              </div>
        ...
        <div className="flex-1 overflow-y-auto px-20">
          <div className={isDarkMode ? 'dark' : ''}>
            <div className="min-h-screen bg-[#1a1f2e] p-6 transition-colors duration-300">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border-l-4" style={{ borderLeftColor: 'var(--accent-blue)' }}>
          <div className="flex gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300 font-roobert-light leading-relaxed whitespace-pre-line">
                {blufData.background}
              </p>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border-l-4" style={{ borderLeftColor: 'var(--accent-green)' }}>
          <div className="flex gap-3">
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-1.5 text-sm text-gray-700 dark:text-gray-300 font-roobert-light">
                {blufData.recommendations.map((item: string, idx: number) => (
                  <li key={idx} className="flex items-start gap-2">
